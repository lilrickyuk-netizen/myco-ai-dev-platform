...
```bash
git remote add encore encore://myco-ai-dev-platform-g8h2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/myco-ai-dev-platform-g8h2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/myco-ai-dev-platform-g8h2/settings/integrations/github)
