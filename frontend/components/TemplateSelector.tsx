...
export default TemplateSelector;import { 
  Code, 
  FileText, 
  Globe, 
  Database, 
...
const templates: Template[] = [
  ...
  },
  {
    ...
    description: "RESTful API with Express.js and Node.js",
    icon: Code,
    tags: ["Backend", "API"],
    popular: true
  },
  ...
  },
  {
    ...
    description: "Full-stack React app with Next.js",
    icon: Zap,
  ...
  },
  {
    id: "python-flask",
    name: "Python + Flask",
    description: "RESTful API with Flask and Python",
    icon: Code,
    tags: ["Backend", "Python"]
  },
  {
    ...
    description: "Full-featured web app with Django",
    icon: Database,
  ...
  },
  {
    id: "game-phaser",
    name: "Phaser Game",
    description: "2D game development with Phaser.js",
    icon: Gamepad2,
    ...
    >
      <CardHeader className="pb-2">
        <div className="flex items-center gap-2">
          ...
          {template.popular && (
            <div className="text-xs bg-orange-100 text-orange-800 dark:bg-orange-900 dark:text-orange-200 px-2 py-1 rounded-full">
              Popular
            </div>
          )}
        </div>
